...
void PSOManager::Create()
{
    ...
    GetPSOBlendPtr("PSO_SPRITE")->CompileShader(ShaderType::VS, "Resources/Shader/SpriteVS.hlsl", "main");
    GetPSOBlendPtr("PSO_SPRITE")->CompileShader(ShaderType::PS, "Resources/Shader/SpritePS.hlsl", "main");
    ...
    GetPSOBlendPtr("PSO_OBJECT3D")->CompileShader(ShaderType::VS, "Resources/Shader/ModelVS.hlsl", "main");
    GetPSOBlendPtr("PSO_OBJECT3D")->CompileShader(ShaderType::PS, "Resources/Shader/ModelPS.hlsl", "main");
    ...
    GetPSOBlendPtr("PSO_POSTEFFECT")->CompileShader(ShaderType::VS, "Resources/Shader/PostEffectVS.hlsl", "main");
    GetPSOBlendPtr("PSO_POSTEFFECT")->CompileShader(ShaderType::PS, "Resources/Shader/PostEffectPS.hlsl", "main");
    ...
    GetPSOBlendPtr("GAUSSIAN")->CompileShader(ShaderType::VS, "Resources/Shader/GaussianBlurVS.hlsl", "main");
    GetPSOBlendPtr("GAUSSIAN")->CompileShader(ShaderType::PS, "Resources/Shader/GaussianBlurPS.hlsl", "main");
    ...
    GetPSOBlendPtr("RADIAL")->CompileShader(ShaderType::VS, "Resources/Shader/RadialBlurVS.hlsl", "main");
    GetPSOBlendPtr("RADIAL")->CompileShader(ShaderType::PS, "Resources/Shader/RadialBlurPS.hlsl", "main");
    GetPSOBlendPtr("RADIAL")->SetRootParameterStructure(2, 2);
    ...
    GetPSOBlendPtr("HIGHLUMI")->CompileShader(ShaderType::VS, "Resources/Shader/HighLumiVS.hlsl", "main");
    GetPSOBlendPtr("HIGHLUMI")->CompileShader(ShaderType::PS, "Resources/Shader/HighLumiPS.hlsl", "main");
    ...
    GetPSOBlendPtr("BLOOM")->CompileShader(ShaderType::VS, "Resources/Shader/BloomVS.hlsl", "main");
    GetPSOBlendPtr("BLOOM")->CompileShader(ShaderType::PS, "Resources/Shader/BloomPS.hlsl", "main");
