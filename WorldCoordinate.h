...
public:
    ...
    inline const Vector3& GetAxisX(void) { return { matWorld_.m[0][0],matWorld_.m[0][1],matWorld_.m[0][2] }; }
    inline const Vector3& GetAxisY(void) { return { matWorld_.m[1][0],matWorld_.m[1][1],matWorld_.m[1][2] }; }
    inline const Vector3& GetAxisZ(void) { return { matWorld_.m[2][0],matWorld_.m[2][1],matWorld_.m[2][2] }; }
